...
export default function AppShell() {
  ...
  return (
    <>
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 z-[55] flex items-center gap-3 px-4 py-3 bg-[#130805]/90 backdrop-blur-md border-b border-gold/10">
        <button
          onClick={() => setSidebarOpen(!sidebarOpen)}
          aria-label="Toggle menu"
          className="p-1.5 rounded border border-gold/20 text-gold/50 hover:text-gold transition-all flex-shrink-0"
        >
          {sidebarOpen ? (
        ...
        <Link to="/" onClick={() => setSidebarOpen(false)}>
          <div className="text-gold font-bold tracking-[0.3em] uppercase text-xs opacity-90">
            Event Horizon
          </div>
          <div className="text-[9px] text-gold/30 tracking-widest uppercase font-mono">
      ...
      <motion.div
        ...
        className={`
          ...
          bg-[#130805] z-[50] flex flex-col justify-between p-8
      ...
      >
        <div>
          <Link
            to="/"
            className="hidden md:block mb-16 group"
            onClick={() => setSidebarOpen(false)}
          >
            <h1 className="text-gold font-bold tracking-[0.4em] uppercase text-sm mb-1 opacity-90 group-hover:opacity-100 transition-opacity">
              Event Horizon
            </h1>
        ...
        <div className="border-t border-gold/10 pt-8">
          ...
          <a
            ...
            className="mt-4 flex items-center gap-2 text-[10px] font-mono text-gold/20 hover:text-gold/50 uppercase tracking-widest transition-colors"
          >
